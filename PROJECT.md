...
| 5 — Implementación dual + residual | ⏳ | Modificación sobre `code/`: forward residual + belief tracker + gating + combinación en el advantage. **Re-estimado 2026-06-12: ~360–550 LOC (central ~430), con costo de cómputo del belief pass comparable al rollout** — sigue quirúrgico en lo que importa (un hook, `core_istar` intocable, cero modelos/rollouts extra). Mapeo completo en [`piar-implementation-points.md`](research/synthesis/piar-implementation-points.md) §7. |
