...
4. ⏳ **Pre-registro de Figura 1** (pivot §8): predicciones P1–P4 sobre ~200 rollouts congelados en WebShop; es el experimento día-1 de compute y el gate go/no-go de fase 4.
